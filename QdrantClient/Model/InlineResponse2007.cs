...
namespace IO.Swagger.Model
{
        ...
        public partial class InlineResponse2007 :  IEquatable<InlineResponse2007>, IValidatableObject
    {
        ...
        public InlineResponse2007(float? time = default(float?), StatusEnum? status = default(StatusEnum?), CollectionClusterInfo result = default(CollectionClusterInfo))
        {
            this.Time = time;
            this.Status = status;
            this.Result = result;
        ...
        public CollectionClusterInfo Result { get; set; }
