...
namespace IO.Swagger.Model
{
        ...
        public partial class InlineResponse200 :  IEquatable<InlineResponse200>, IValidatableObject
    {
        ...
        public InlineResponse200(float? time = default(float?), StatusEnum? status = default(StatusEnum?), TelemetryData result = default(TelemetryData))
        {
            this.Time = time;
            this.Status = status;
            this.Result = result;
        ...
        public TelemetryData Result { get; set; }
