...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class GeoBoundingBox :  IEquatable<GeoBoundingBox>, IValidatableObject, AnyOfFieldConditionGeoBoundingBox 
    {
        /// <summary>
        ...
        public GeoBoundingBox(GeoPoint topLeft = default(GeoPoint), GeoPoint bottomRight = default(GeoPoint))
        {
            ...
            if (topLeft == null)
            {
                throw new InvalidDataException("topLeft is a required property for GeoBoundingBox and cannot be null");
            }
            else
            {
            ...
            if (bottomRight == null)
            {
                throw new InvalidDataException("bottomRight is a required property for GeoBoundingBox and cannot be null");
            }
            else
            {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GeoBoundingBox {\n");
        ...
        {
            return this.Equals(input as GeoBoundingBox);
        }

        /// <summary>
        /// Returns true if GeoBoundingBox instances are equal
        /// </summary>
        /// <param name="input">Instance of GeoBoundingBox to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GeoBoundingBox input)
        {
            if (input == null)
                return false;
