...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class Replica :  IEquatable<Replica>, IValidatableObject
    {
        /// <summary>
        ...
        public Replica(int? shardId = default(int?), int? peerId = default(int?))
        {
            // to ensure "shardId" is required (not null)
            if (shardId == null)
            {
                throw new InvalidDataException("shardId is a required property for Replica and cannot be null");
            }
            else
            {
            ...
            if (peerId == null)
            {
                throw new InvalidDataException("peerId is a required property for Replica and cannot be null");
            }
            else
            {
                this.PeerId = peerId;
