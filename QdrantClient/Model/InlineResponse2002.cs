...
namespace IO.Swagger.Model
{
        ...
        public partial class InlineResponse2002 :  IEquatable<InlineResponse2002>, IValidatableObject
    {
        ...
        public InlineResponse2002(float? time = default(float?), StatusEnum? status = default(StatusEnum?), ClusterStatus result = default(ClusterStatus))
        {
            this.Time = time;
            this.Status = status;
            this.Result = result;
        ...
        public ClusterStatus Result { get; set; }
