...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class ValuesCount :  IEquatable<ValuesCount>, IValidatableObject, AnyOfFieldConditionValuesCount 
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ValuesCount" /> class.
        /// </summary>
        /// <param name="lt">point.key.length() &lt; values_count.lt.</param>
        /// <param name="gt">point.key.length() &gt; values_count.gt.</param>
        /// <param name="gte">point.key.length() &gt;&#x3D; values_count.gte.</param>
        /// <param name="lte">point.key.length() &lt;&#x3D; values_count.lte.</param>
        public ValuesCount(int? lt = default(int?), int? gt = default(int?), int? gte = default(int?), int? lte = default(int?))
        {
            this.Lt = lt;
            this.Gt = gt;
            this.Gte = gte;
        ...
        /// </summary>
        /// <value>point.key.length() &lt; values_count.lt</value>
        ...
        /// </summary>
        /// <value>point.key.length() &gt; values_count.gt</value>
        ...
        /// </summary>
        /// <value>point.key.length() &gt;&#x3D; values_count.gte</value>
        ...
        /// </summary>
        /// <value>point.key.length() &lt;&#x3D; values_count.lte</value>
        ...
        {
            return this.Equals(input as ValuesCount);
        }

        /// <summary>
        /// Returns true if ValuesCount instances are equal
        /// </summary>
        /// <param name="input">Instance of ValuesCount to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ValuesCount input)
        {
            if (input == null)
                return false;
