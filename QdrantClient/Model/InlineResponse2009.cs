...
namespace IO.Swagger.Model
{
        ...
        public partial class InlineResponse2009 :  IEquatable<InlineResponse2009>, IValidatableObject
    {
        ...
        public InlineResponse2009(float? time = default(float?), StatusEnum? status = default(StatusEnum?), List<SnapshotDescription> result = default(List<SnapshotDescription>))
        {
            this.Time = time;
            this.Status = status;
            this.Result = result;
        ...
        public List<SnapshotDescription> Result { get; set; }
