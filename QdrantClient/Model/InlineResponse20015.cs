...
namespace IO.Swagger.Model
{
        ...
        public partial class InlineResponse20015 :  IEquatable<InlineResponse20015>, IValidatableObject
    {
        ...
        public InlineResponse20015(float? time = default(float?), StatusEnum? status = default(StatusEnum?), List<List<ScoredPoint>> result = default(List<List<ScoredPoint>>))
        {
            this.Time = time;
            this.Status = status;
            this.Result = result;
        ...
        public List<List<ScoredPoint>> Result { get; set; }
