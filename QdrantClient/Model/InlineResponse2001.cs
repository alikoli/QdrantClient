...
namespace IO.Swagger.Model
{
        ...
        public partial class InlineResponse2001 :  IEquatable<InlineResponse2001>, IValidatableObject
    {
        ...
        public InlineResponse2001(float? time = default(float?), StatusEnum? status = default(StatusEnum?), LocksOption result = default(LocksOption))
        {
            this.Time = time;
            this.Status = status;
            this.Result = result;
        ...
        public LocksOption Result { get; set; }
