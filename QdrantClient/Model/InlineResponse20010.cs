...
namespace IO.Swagger.Model
{
        ...
        public partial class InlineResponse20010 :  IEquatable<InlineResponse20010>, IValidatableObject
    {
        ...
        public InlineResponse20010(float? time = default(float?), StatusEnum? status = default(StatusEnum?), SnapshotDescription result = default(SnapshotDescription))
        {
            this.Time = time;
            this.Status = status;
            this.Result = result;
        ...
        public SnapshotDescription Result { get; set; }
