...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class CollectionsResponse :  IEquatable<CollectionsResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CollectionsResponse" /> class.
        /// </summary>
        /// <param name="collections">collections (required).</param>
        public CollectionsResponse(List<CollectionDescription> collections = default(List<CollectionDescription>))
        {
            // to ensure "collections" is required (not null)
            if (collections == null)
            {
                throw new InvalidDataException("collections is a required property for CollectionsResponse and cannot be null");
            }
            else
            {
        ...
        {
            return this.Equals(input as CollectionsResponse);
        }

        /// <summary>
        /// Returns true if CollectionsResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of CollectionsResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CollectionsResponse input)
        {
            if (input == null)
                return false;
