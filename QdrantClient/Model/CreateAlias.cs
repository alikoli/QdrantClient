...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class CreateAlias :  IEquatable<CreateAlias>, IValidatableObject
    {
        /// <summary>
        ...
        public CreateAlias(string collectionName = default(string), string aliasName = default(string))
        {
            // to ensure "collectionName" is required (not null)
            if (collectionName == null)
            {
                throw new InvalidDataException("collectionName is a required property for CreateAlias and cannot be null");
            }
            else
            {
            ...
            if (aliasName == null)
            {
                throw new InvalidDataException("aliasName is a required property for CreateAlias and cannot be null");
            }
            else
            {
        ...
        {
            return this.Equals(input as CreateAlias);
        }

        /// <summary>
        /// Returns true if CreateAlias instances are equal
        /// </summary>
        /// <param name="input">Instance of CreateAlias to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CreateAlias input)
        {
            if (input == null)
                return false;
