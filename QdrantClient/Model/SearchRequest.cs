...
namespace IO.Swagger.Model
{
        ...
        public partial class SearchRequest :  IEquatable<SearchRequest>, IValidatableObject
    {
        ...
        public SearchRequest(NamedVectorStruct vector = default(NamedVectorStruct), AnyOfSearchRequestFilter filter = default(AnyOfSearchRequestFilter), AnyOfSearchRequestParams _params = default(AnyOfSearchRequestParams), int? limit = default(int?), int? offset = 0, AnyOfSearchRequestWithPayload withPayload = default(AnyOfSearchRequestWithPayload), AnyOfSearchRequestWithVector withVector = default(AnyOfSearchRequestWithVector), float? scoreThreshold = default(float?))
        {
            // to ensure "vector" is required (not null)
            if (vector == null)
            {
                throw new InvalidDataException("vector is a required property for SearchRequest and cannot be null");
            }
            else
            {
                this.Vector = vector;
            ...
            if (limit == null)
            {
                throw new InvalidDataException("limit is a required property for SearchRequest and cannot be null");
            }
            else
            {
                this.Limit = limit;
        ...
        public NamedVectorStruct Vector { get; set; }
        ...
        public AnyOfSearchRequestFilter Filter { get; set; }
        ...
        public AnyOfSearchRequestParams _Params { get; set; }
        ...
        public AnyOfSearchRequestWithPayload WithPayload { get; set; }
        ...
        public AnyOfSearchRequestWithVector WithVector { get; set; }
