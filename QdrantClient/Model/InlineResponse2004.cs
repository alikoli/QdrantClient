...
namespace IO.Swagger.Model
{
        ...
        public partial class InlineResponse2004 :  IEquatable<InlineResponse2004>, IValidatableObject
    {
        ...
        public InlineResponse2004(float? time = default(float?), StatusEnum? status = default(StatusEnum?), CollectionsResponse result = default(CollectionsResponse))
        {
            this.Time = time;
            this.Status = status;
            this.Result = result;
        ...
        public CollectionsResponse Result { get; set; }
