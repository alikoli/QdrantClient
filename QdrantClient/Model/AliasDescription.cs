...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class AliasDescription :  IEquatable<AliasDescription>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AliasDescription" /> class.
        /// </summary>
        /// <param name="aliasName">aliasName (required).</param>
        /// <param name="collectionName">collectionName (required).</param>
        public AliasDescription(string aliasName = default(string), string collectionName = default(string))
        {
            // to ensure "aliasName" is required (not null)
            if (aliasName == null)
            {
                throw new InvalidDataException("aliasName is a required property for AliasDescription and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("collectionName is a required property for AliasDescription and cannot be null");
            }
            else
            {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AliasDescription {\n");
        ...
        {
            return this.Equals(input as AliasDescription);
        }

        /// <summary>
        /// Returns true if AliasDescription instances are equal
        /// </summary>
        /// <param name="input">Instance of AliasDescription to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AliasDescription input)
        {
            if (input == null)
                return false;
